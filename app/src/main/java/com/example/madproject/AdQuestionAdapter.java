...
public class AdQuestionAdapter extends RecyclerView.Adapter<AdQuestionAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public AdQuestionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdQuestionAdapter.ViewHolder holder, int pos) {
